...
app.use(function(req, res, next) {
    ...
    var file = '';
    if (req.headers['accept-language'] == settings.language.swedish) {
        lang = settings.language.swedish;
    }else if (req.headers['accept-language'] == settings.language.danish) {
        lang = settings.language.danish;
    }
    file = lcid.from(lang);
...
app.use('/', carCMSRouter);


// Mobile API's
app.use('/api/user/', apiMobileUserManagementRouter);
app.use('/api/', apiMobileCarManagementRouter);
